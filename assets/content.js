    ...
    skills: {
      ...
      cards: [
        { title: { ko: "문서 · 명세", en: "Documents & specs" },
          ...
          tags:  [ { ko: "Figma", en: "Figma" }, { ko: "MS Office", en: "MS Office" }, { ko: "문서 도구 자격증", en: "Document cert." } ] },
        { title: { ko: "지식 관리 · 옵시디언", en: "Knowledge management" },
          body:  { ko: "옵시디언으로 문서를 작성·분류하고, 플러그인과 AI 자동 분류를 붙여 운용합니다.",
                   en: "Drafting and classifying in Obsidian, with plugins and AI-assisted filing." },
          tags:  [ { ko: "Obsidian", en: "Obsidian" }, { ko: "플러그인", en: "Plugins" }, { ko: "AI 분류", en: "AI filing" } ] },
        { title: { ko: "AI 활용", en: "AI utilisation" },
          ...
          tags:  [ { ko: "콘텐츠 제작", en: "Content" }, { ko: "챗봇", en: "Chatbots" }, { ko: "자료조사 자동화", en: "Research automation" } ] },
        { title: { ko: "협업 도구", en: "Collaboration" },
          body:  { ko: "출시일이 고정된 소규모 팀의 일정·버전 관리에 사용합니다.",
                   en: "Schedule and version management for small teams with fixed dates." },
          tags:  [ { ko: "GitHub", en: "GitHub" }, { ko: "Notion", en: "Notion" }, { ko: "Jira", en: "Jira" }, { ko: "스프레드시트", en: "Sheets" } ] },
        { title: { ko: "개발 도구", en: "Development" },
          body:  { ko: "제 기획은 직접 프로토타입으로 만듭니다. 쓴 그 주에 검증할 수 있다는 뜻입니다.",
                   en: "I prototype my own designs, testable the same week they're written." },
        ...
        { title: { ko: "시장 분석", en: "Market analysis" },
          ...
          tags:  [ { ko: "트렌드 추적", en: "Trend tracking" }, { ko: "플랫폼 분석", en: "Platform analysis" }, { ko: "순위 자동화", en: "Chart logging" } ] }
      ]
    },
